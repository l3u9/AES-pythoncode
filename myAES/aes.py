...
class AES:
    def __init__(self, master_key, version):
    ...
    def encrypt(self, plaintext):
        ...
        self.add_round_key(self.plain_state, self.round_keys[4 * self.round:])
    ...
    def decrypt(self, ciphertext):
        ...
        self.add_round_key(self.cipher_state, self.round_keys[self.round * 4:])
        self.inv_shift_rows(self.cipher_state)
        self.inv_sub_bytes(self.cipher_state)

        for i in reversed(range(1,self.round)):
    ...
    def round_encrypt(self, state, key):
        self.sub_bytes(state)
        self.shift_rows(state)
        self.mix_columns(state)
        self.add_round_key(state, key)

    def round_decrypt(self, state, key):
        self.add_round_key(state, key)
    ...
    def key_schedule(self, master_key):
        ...
        l = int(self.key_length/4)

        self.round_keys = text2matrix(master_key)
        
        for i in range(l, 4*(self.round + 1)):
            
            t = copy.deepcopy(self.round_keys[i-1])
            ...
            if i % 4 == 0:  
                ...
                rconword = [Rcon[int(i/4)], 0x00, 0x00, 0x00]
                t = ArrXor(t,rconword)

            elif l > 6 and i % l == 4:
                t = SubWord(t)  
                    
            self.round_keys.append(ArrXor(self.round_keys[i-4], t))
